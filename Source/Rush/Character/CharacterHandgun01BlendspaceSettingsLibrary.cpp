#include "CharacterHandgun01BlendspaceSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterBlendspaceName, FCharacterBlendspaceSettings> GCharacterHandgun01BlendspaceSettingsMap;

static void InitCharacterHandgun01BlendspaceSettingsMap()
{
    if (GCharacterHandgun01BlendspaceSettingsMap.Num() > 0) return;
    ...
    GCharacterHandgun01BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Walking, WalkingSettings);
    ...
    GCharacterHandgun01BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Leaning, LeaningSettings);

    // Aim-Offset
    FCharacterBlendspaceSettings AimOffsetSettings = CreateBlendspaceSettings(
        TEXT("/Script/Engine.BlendSpace1D'/Game/Assets/Character/Blendspace/Handguns/BS_TP_CH_Handgun_01_Look.BS_TP_CH_Handgun_01_Look'")
    );
    GCharacterHandgun01BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Aim_Offset, AimOffsetSettings);
}

FCharacterBlendspaceSettings UCharacterHandgun01BlendspaceSettingsLibrary::GetCharacterHandgun01BlendspaceSettingsByName(ECharacterBlendspaceName BlendspaceName)
{
    InitCharacterHandgun01BlendspaceSettingsMap();
    if (GCharacterHandgun01BlendspaceSettingsMap.Contains(BlendspaceName))
    {
        return GCharacterHandgun01BlendspaceSettingsMap[BlendspaceName];
    }
