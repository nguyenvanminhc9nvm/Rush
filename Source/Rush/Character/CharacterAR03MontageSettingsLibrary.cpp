...
static void InitCharacterAR03MontageSettingsMap()
{
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Fire, FireSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Fire_Empty, FireEmptySettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Reload, ReloadSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Inspect, InspectSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Holster, HolsterSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Unholster, UnholsterSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterAR03MontageSettingsMap.Add(ECharacterMontageName::Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}
