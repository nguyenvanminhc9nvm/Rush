...
static void InitCharacterSMG04MontageSettingsMap()
{
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Fire, FireSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Fire_Empty, FireEmptySettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Reload, ReloadSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Inspect, InspectSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Holster, HolsterSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Unholster, UnholsterSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterSMG04MontageSettingsMap.Add(ECharacterMontageName::Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}
