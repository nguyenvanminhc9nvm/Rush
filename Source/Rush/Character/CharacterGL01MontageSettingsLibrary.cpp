...
static void InitCharacterGL01MontageSettingsMap()
{
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Fire, FireSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Fire_Empty, FireEmptySettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Reload, ReloadSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Inspect, InspectSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Holster, HolsterSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Unholster, UnholsterSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}
