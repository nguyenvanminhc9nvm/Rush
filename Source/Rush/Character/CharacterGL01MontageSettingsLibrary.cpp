#include "CharacterGL01MontageSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterMontageName, FCharacterMontageSettings> GCharacterGL01MontageSettingsMap;

static void InitCharacterGL01MontageSettingsMap()
{
    if (GCharacterGL01MontageSettingsMap.Num() > 0) return;
    ...
    FCharacterMontageSettings FireSettings = CreateMontageSettings(
        TEXT("/Script/Engine.AnimMontage'/Game/Assets/Character/Montage/Launchers/AM_FP_PCH_GL_01_Fire.AM_FP_PCH_GL_01_Fire'"),
        TEXT("/Script/Engine.AnimMontage'/Game/Assets/Character/Montage/Launchers/AM_TP_CH_GL_01_Fire.AM_TP_CH_GL_01_Fire'")
    );
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire, FireSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire_Empty, FireEmptySettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload, ReloadSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload_Empty, ReloadEmptySettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect, InspectSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster, HolsterSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster, UnholsterSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterGL01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}

FCharacterMontageSettings UCharacterGL01MontageSettingsLibrary::GetCharacterGL01MontageSettingsByName(ECharacterMontageName MontageName)
{
    InitCharacterGL01MontageSettingsMap();
    if (GCharacterGL01MontageSettingsMap.Contains(MontageName))
    {
        return GCharacterGL01MontageSettingsMap[MontageName];
    }
    return FCharacterMontageSettings(); // Return default settings if not found
}

TArray<FCharacterMontageSettings> UCharacterGL01MontageSettingsLibrary::GetAllCharacterGL01MontageSettings()
{
    InitCharacterGL01MontageSettingsMap();
    TArray<FCharacterMontageSettings> AllSettings;
    GCharacterGL01MontageSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
