...
static void InitCharacterHandgun03SkullsMontageSettingsMap()
{
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Fire, FireSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Fire_Empty, FireEmptySettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Reload, ReloadSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Inspect, InspectSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Holster, HolsterSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Unholster, UnholsterSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}
