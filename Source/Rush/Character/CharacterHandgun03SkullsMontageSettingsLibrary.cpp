#include "CharacterHandgun03SkullsMontageSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterMontageName, FCharacterMontageSettings> GCharacterHandgun03SkullsMontageSettingsMap;

static void InitCharacterHandgun03SkullsMontageSettingsMap()
{
    if (GCharacterHandgun03SkullsMontageSettingsMap.Num() > 0) return;
    ...
    FCharacterMontageSettings FireSettings = CreateMontageSettings(
        TEXT("/Script/Engine.AnimMontage'/Game/Assets/Character/Montage/Handguns/AM_FP_PCH_Handgun_Skulls_Fire.AM_FP_PCH_Handgun_Skulls_Fire'"),
        TEXT("/Script/Engine.AnimMontage'/Game/Assets/Character/Montage/SMGs/AM_TP_CH_SMG_Fire.AM_TP_CH_SMG_Fire'")
    );
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire, FireSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire_Empty, FireEmptySettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload, ReloadSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload_Empty, ReloadEmptySettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect, InspectSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster, HolsterSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster, UnholsterSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterHandgun03SkullsMontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}

FCharacterMontageSettings UCharacterHandgun03SkullsMontageSettingsLibrary::GetCharacterHandgun03SkullsMontageSettingsByName(ECharacterMontageName MontageName)
{
    InitCharacterHandgun03SkullsMontageSettingsMap();
    if (GCharacterHandgun03SkullsMontageSettingsMap.Contains(MontageName))
    {
        return GCharacterHandgun03SkullsMontageSettingsMap[MontageName];
    }
