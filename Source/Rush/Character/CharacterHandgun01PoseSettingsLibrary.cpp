#include "CharacterHandgun01PoseSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterPoseName, FCharacterPoseSettings> GCharacterHandgun01PoseSettingsMap;

static void InitCharacterHandgun01PoseSettingsMap()
{
    if (GCharacterHandgun01PoseSettingsMap.Num() > 0) return;
    ...
    GCharacterHandgun01PoseSettingsMap.Add(ECharacterPoseName::Idle, IdleSettings);
    ...
    GCharacterHandgun01PoseSettingsMap.Add(ECharacterPoseName::Idle_Walking, IdleWalkingSettings);
    ...
    GCharacterHandgun01PoseSettingsMap.Add(ECharacterPoseName::Idle_Crouch, IdleCrouchSettings);
    ...
    GCharacterHandgun01PoseSettingsMap.Add(ECharacterPoseName::Aim, AimSettings);
    ...
    GCharacterHandgun01PoseSettingsMap.Add(ECharacterPoseName::Aim_Walking, AimWalkingSettings);
    ...
    GCharacterHandgun01PoseSettingsMap.Add(ECharacterPoseName::Aim_Crouch, AimCrouchSettings);
    ...
    GCharacterHandgun01PoseSettingsMap.Add(ECharacterPoseName::Ready, ReadySettings);
    ...
    GCharacterHandgun01PoseSettingsMap.Add(ECharacterPoseName::Ready_Walking, ReadyWalkingSettings);
    ...
    GCharacterHandgun01PoseSettingsMap.Add(ECharacterPoseName::Ready_Crouch, ReadyCrouchSettings);
}

FCharacterPoseSettings UCharacterHandgun01PoseSettingsLibrary::GetCharacterHandgun01PoseSettingsByName(ECharacterPoseName PoseName)
{
    InitCharacterHandgun01PoseSettingsMap();
    if (GCharacterHandgun01PoseSettingsMap.Contains(PoseName))
    {
        return GCharacterHandgun01PoseSettingsMap[PoseName];
    }
    return FCharacterPoseSettings(); // Return default settings if not found
}

TArray<FCharacterPoseSettings> UCharacterHandgun01PoseSettingsLibrary::GetAllCharacterHandgun01PoseSettings()
{
    InitCharacterHandgun01PoseSettingsMap();
    TArray<FCharacterPoseSettings> AllSettings;
    GCharacterHandgun01PoseSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
