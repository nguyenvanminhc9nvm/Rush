...
static TMap<ECharacterPoseName, FCharacterSequenceSettings> GCharacterHandgun04SequenceSettingsMap;
...
static void InitCharacterHandgun04SequenceSettingsMap()
{
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterPoseName::Standing_Breathing, StandingBreathingSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterPoseName::Aiming_Walking, AimingWalkingSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterPoseName::Aiming_Breathing, AimingBreathingSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterPoseName::Turning, TurningSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterPoseName::Jog, JogSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterPoseName::Sprint, SprintSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterPoseName::Sprint_Impulse, SprintImpulseSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterPoseName::Sprint_Tactical, SprintTacticalSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterPoseName::Crouching_Walking, CrouchingWalkingSettings);
}

FCharacterSequenceSettings UCharacterHandgun04SequenceSettingsLibrary::GetCharacterHandgun04SequenceSettingsByName(ECharacterPoseName SequenceName)
{
