...
static void InitCharacterSMG05MontageSettingsMap()
{
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire, FireSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire_Empty, FireEmptySettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload, ReloadSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload_Empty, ReloadEmptySettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect, InspectSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster, HolsterSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster, UnholsterSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterSMG05MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}
...
TArray<FCharacterMontageSettings> UCharacterSMG05MontageSettingsLibrary::GetAllCharacterSMG05MontageSettings()
{
    InitCharacterSMG05MontageSettingsMap();
    TArray<FCharacterMontageSettings> AllSettings;
    GCharacterSMG05MontageSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
