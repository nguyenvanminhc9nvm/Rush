#include "CharacterSMG03BlendspaceSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterBlendspaceName, FCharacterBlendspaceSettings> GCharacterSMG03BlendspaceSettingsMap;

static void InitCharacterSMG03BlendspaceSettingsMap()
{
    if (GCharacterSMG03BlendspaceSettingsMap.Num() > 0) return;
    ...
    GCharacterSMG03BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Walking, WalkingSettings);
    ...
    GCharacterSMG03BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Leaning, LeaningSettings);

    // Aim-Offset
    FCharacterBlendspaceSettings AimOffsetSettings = CreateBlendspaceSettings(
        TEXT("/Script/Engine.BlendSpace1D'/Game/Assets/Character/Blendspace/SMGs/BS_TP_CH_SMG_03_Look.BS_TP_CH_SMG_03_Look'")
    );
    GCharacterSMG03BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Aim_Offset, AimOffsetSettings);
}

FCharacterBlendspaceSettings UCharacterSMG03BlendspaceSettingsLibrary::GetCharacterSMG03BlendspaceSettingsByName(ECharacterBlendspaceName BlendspaceName)
{
    InitCharacterSMG03BlendspaceSettingsMap();
    if (GCharacterSMG03BlendspaceSettingsMap.Contains(BlendspaceName))
    {
        return GCharacterSMG03BlendspaceSettingsMap[BlendspaceName];
    }
