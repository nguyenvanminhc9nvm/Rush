...
static TMap<ECharacterPoseName, FCharacterSequenceSettings> GCharacterAR03SequenceSettingsMap;
...
static void InitCharacterAR03SequenceSettingsMap()
{
    ...
    GCharacterAR03SequenceSettingsMap.Add(ECharacterPoseName::Standing_Breathing, StandingBreathingSettings);
    ...
    GCharacterAR03SequenceSettingsMap.Add(ECharacterPoseName::Aiming_Walking, AimingWalkingSettings);
    ...
    GCharacterAR03SequenceSettingsMap.Add(ECharacterPoseName::Aiming_Breathing, AimingBreathingSettings);
    ...
    GCharacterAR03SequenceSettingsMap.Add(ECharacterPoseName::Turning, TurningSettings);
    ...
    GCharacterAR03SequenceSettingsMap.Add(ECharacterPoseName::Jog, JogSettings);
    ...
    GCharacterAR03SequenceSettingsMap.Add(ECharacterPoseName::Sprint, SprintSettings);
    ...
    GCharacterAR03SequenceSettingsMap.Add(ECharacterPoseName::Sprint_Impulse, SprintImpulseSettings);
    ...
    GCharacterAR03SequenceSettingsMap.Add(ECharacterPoseName::Sprint_Tactical, SprintTacticalSettings);
    ...
    GCharacterAR03SequenceSettingsMap.Add(ECharacterPoseName::Crouching_Walking, CrouchingWalkingSettings);
}

FCharacterSequenceSettings UCharacterAR03SequenceSettingsLibrary::GetCharacterAR03SequenceSettingsByName(ECharacterPoseName SequenceName)
{
