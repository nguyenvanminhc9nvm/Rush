...
static TMap<ECharacterSequenceName, FCharacterSequenceSettings> GCharacterSniper02SequenceSettingsMap;
...
static void InitCharacterSniper02SequenceSettingsMap()
{
    ...
    GCharacterSniper02SequenceSettingsMap.Add(ECharacterSequenceName::Standing_Breathing, StandingBreathingSettings);
    ...
    GCharacterSniper02SequenceSettingsMap.Add(ECharacterSequenceName::Aiming_Walking, AimingWalkingSettings);
    ...
    GCharacterSniper02SequenceSettingsMap.Add(ECharacterSequenceName::Aiming_Breathing, AimingBreathingSettings);
    ...
    GCharacterSniper02SequenceSettingsMap.Add(ECharacterSequenceName::Turning, TurningSettings);
    ...
    GCharacterSniper02SequenceSettingsMap.Add(ECharacterSequenceName::Jog, JogSettings);
    ...
    GCharacterSniper02SequenceSettingsMap.Add(ECharacterSequenceName::Sprint, SprintSettings);
    ...
    GCharacterSniper02SequenceSettingsMap.Add(ECharacterSequenceName::Sprint_Impulse, SprintImpulseSettings);
    ...
    GCharacterSniper02SequenceSettingsMap.Add(ECharacterSequenceName::Sprint_Tactical, SprintTacticalSettings);
    ...
    GCharacterSniper02SequenceSettingsMap.Add(ECharacterSequenceName::Crouching_Walking, CrouchingWalkingSettings);
}

FCharacterSequenceSettings UCharacterSniper02SequenceSettingsLibrary::GetCharacterSniper02SequenceSettingsByName(ECharacterSequenceName SequenceName)
{
