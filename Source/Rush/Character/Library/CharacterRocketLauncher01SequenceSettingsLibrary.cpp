...
static TMap<ECharacterPoseName, FCharacterSequenceSettings> GCharacterRocketLauncher01SequenceSettingsMap;
...
static void InitCharacterRocketLauncher01SequenceSettingsMap()
{
    ...
    GCharacterRocketLauncher01SequenceSettingsMap.Add(ECharacterPoseName::Standing_Breathing, StandingBreathingSettings);
    ...
    GCharacterRocketLauncher01SequenceSettingsMap.Add(ECharacterPoseName::Aiming_Walking, AimingWalkingSettings);
    ...
    GCharacterRocketLauncher01SequenceSettingsMap.Add(ECharacterPoseName::Aiming_Breathing, AimingBreathingSettings);
    ...
    GCharacterRocketLauncher01SequenceSettingsMap.Add(ECharacterPoseName::Turning, TurningSettings);
    ...
    GCharacterRocketLauncher01SequenceSettingsMap.Add(ECharacterPoseName::Jog, JogSettings);
    ...
    GCharacterRocketLauncher01SequenceSettingsMap.Add(ECharacterPoseName::Sprint, SprintSettings);
    ...
    GCharacterRocketLauncher01SequenceSettingsMap.Add(ECharacterPoseName::Sprint_Impulse, SprintImpulseSettings);
    ...
    GCharacterRocketLauncher01SequenceSettingsMap.Add(ECharacterPoseName::Sprint_Tactical, SprintTacticalSettings);
    ...
    GCharacterRocketLauncher01SequenceSettingsMap.Add(ECharacterPoseName::Crouching_Walking, CrouchingWalkingSettings);
}

FCharacterSequenceSettings UCharacterRocketLauncher01SequenceSettingsLibrary::GetCharacterRocketLauncher01SequenceSettingsByName(ECharacterPoseName SequenceName)
{
