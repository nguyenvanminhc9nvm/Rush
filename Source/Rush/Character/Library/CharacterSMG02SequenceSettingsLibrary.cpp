...
static TMap<ECharacterPoseName, FCharacterSequenceSettings> GCharacterSMG02SequenceSettingsMap;
...
static void InitCharacterSMG02SequenceSettingsMap()
{
    ...
    GCharacterSMG02SequenceSettingsMap.Add(ECharacterPoseName::Standing_Breathing, StandingBreathingSettings);
    ...
    GCharacterSMG02SequenceSettingsMap.Add(ECharacterPoseName::Aiming_Walking, AimingWalkingSettings);
    ...
    GCharacterSMG02SequenceSettingsMap.Add(ECharacterPoseName::Aiming_Breathing, AimingBreathingSettings);
    ...
    GCharacterSMG02SequenceSettingsMap.Add(ECharacterPoseName::Turning, TurningSettings);
    ...
    GCharacterSMG02SequenceSettingsMap.Add(ECharacterPoseName::Jog, JogSettings);
    ...
    GCharacterSMG02SequenceSettingsMap.Add(ECharacterPoseName::Sprint, SprintSettings);
    ...
    GCharacterSMG02SequenceSettingsMap.Add(ECharacterPoseName::Sprint_Impulse, SprintImpulseSettings);
    ...
    GCharacterSMG02SequenceSettingsMap.Add(ECharacterPoseName::Sprint_Tactical, SprintTacticalSettings);
    ...
    GCharacterSMG02SequenceSettingsMap.Add(ECharacterPoseName::Crouching_Walking, CrouchingWalkingSettings);
}

FCharacterSequenceSettings UCharacterSMG02SequenceSettingsLibrary::GetCharacterSMG02SequenceSettingsByName(ECharacterPoseName SequenceName)
{
