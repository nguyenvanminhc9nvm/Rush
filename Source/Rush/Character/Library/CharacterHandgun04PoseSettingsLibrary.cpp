#include "CharacterHandgun04PoseSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterPoseName, FCharacterPoseSettings> GCharacterHandgun04PoseSettingsMap;

static void InitCharacterHandgun04PoseSettingsMap()
{
    if (GCharacterHandgun04PoseSettingsMap.Num() > 0) return;
    ...
    GCharacterHandgun04PoseSettingsMap.Add(ECharacterPoseName::Idle, IdleSettings);
    ...
    GCharacterHandgun04PoseSettingsMap.Add(ECharacterPoseName::Idle_Walking, IdleWalkingSettings);
    ...
    GCharacterHandgun04PoseSettingsMap.Add(ECharacterPoseName::Idle_Crouch, IdleCrouchSettings);
    ...
    GCharacterHandgun04PoseSettingsMap.Add(ECharacterPoseName::Aim, AimSettings);
    ...
    GCharacterHandgun04PoseSettingsMap.Add(ECharacterPoseName::Aim_Walking, AimWalkingSettings);
    ...
    GCharacterHandgun04PoseSettingsMap.Add(ECharacterPoseName::Aim_Crouch, AimCrouchSettings);
    ...
    GCharacterHandgun04PoseSettingsMap.Add(ECharacterPoseName::Ready, ReadySettings);
    ...
    GCharacterHandgun04PoseSettingsMap.Add(ECharacterPoseName::Ready_Walking, ReadyWalkingSettings);
    ...
    GCharacterHandgun04PoseSettingsMap.Add(ECharacterPoseName::Ready_Crouch, ReadyCrouchSettings);
}

FCharacterPoseSettings UCharacterHandgun04PoseSettingsLibrary::GetCharacterHandgun04PoseSettingsByName(ECharacterPoseName PoseName)
{
    InitCharacterHandgun04PoseSettingsMap();
    if (GCharacterHandgun04PoseSettingsMap.Contains(PoseName))
    {
        return GCharacterHandgun04PoseSettingsMap[PoseName];
    }
    return FCharacterPoseSettings(); // Return default settings if not found
}

TArray<FCharacterPoseSettings> UCharacterHandgun04PoseSettingsLibrary::GetAllCharacterHandgun04PoseSettings()
{
    InitCharacterHandgun04PoseSettingsMap();
    TArray<FCharacterPoseSettings> AllSettings;
    GCharacterHandgun04PoseSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
