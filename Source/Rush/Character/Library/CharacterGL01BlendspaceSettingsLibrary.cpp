#include "CharacterGL01BlendspaceSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterBlendspaceName, FCharacterBlendspaceSettings> GCharacterGL01BlendspaceSettingsMap;

static void InitCharacterGL01BlendspaceSettingsMap()
{
    if (GCharacterGL01BlendspaceSettingsMap.Num() > 0) return;
    ...
    GCharacterGL01BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Walking, WalkingSettings);
    ...
    GCharacterGL01BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Leaning, LeaningSettings);

    // Aim-Offset
    FCharacterBlendspaceSettings AimOffsetSettings = CreateBlendspaceSettings(
        TEXT("/Script/Engine.BlendSpace1D'/Game/Assets/Character/Blendspace/Launchers/BS_TP_CH_GL_01_Look.BS_TP_CH_GL_01_Look'")
    );
    GCharacterGL01BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Aim_Offset, AimOffsetSettings);
}

FCharacterBlendspaceSettings UCharacterGL01BlendspaceSettingsLibrary::GetCharacterGL01BlendspaceSettingsByName(ECharacterBlendspaceName BlendspaceName)
{
    InitCharacterGL01BlendspaceSettingsMap();
    if (GCharacterGL01BlendspaceSettingsMap.Contains(BlendspaceName))
    {
        return GCharacterGL01BlendspaceSettingsMap[BlendspaceName];
    }
