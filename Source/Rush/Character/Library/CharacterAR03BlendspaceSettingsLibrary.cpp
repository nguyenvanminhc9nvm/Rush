#include "CharacterAR03BlendspaceSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterBlendspaceName, FCharacterBlendspaceSettings> GCharacterAR03BlendspaceSettingsMap;

static void InitCharacterAR03BlendspaceSettingsMap()
{
    if (GCharacterAR03BlendspaceSettingsMap.Num() > 0) return;
    ...
    GCharacterAR03BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Walking, WalkingSettings);
    ...
    GCharacterAR03BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Leaning, LeaningSettings);

    // Aim-Offset
    FCharacterBlendspaceSettings AimOffsetSettings = CreateBlendspaceSettings(
        TEXT("/Script/Engine.BlendSpace1D'/Game/Assets/Character/Blendspace/ARs/BS_TP_CH_AR_03_Look.BS_TP_CH_AR_03_Look'")
    );
    GCharacterAR03BlendspaceSettingsMap.Add(ECharacterBlendspaceName::Aim_Offset, AimOffsetSettings);
}

FCharacterBlendspaceSettings UCharacterAR03BlendspaceSettingsLibrary::GetCharacterAR03BlendspaceSettingsByName(ECharacterBlendspaceName BlendspaceName)
{
    InitCharacterAR03BlendspaceSettingsMap();
    if (GCharacterAR03BlendspaceSettingsMap.Contains(BlendspaceName))
    {
        return GCharacterAR03BlendspaceSettingsMap[BlendspaceName];
    }
