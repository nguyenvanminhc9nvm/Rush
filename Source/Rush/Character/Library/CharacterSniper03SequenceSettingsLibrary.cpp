...
static TMap<ECharacterPoseName, FCharacterSequenceSettings> GCharacterSniper03SequenceSettingsMap;
...
static void InitCharacterSniper03SequenceSettingsMap()
{
    ...
    GCharacterSniper03SequenceSettingsMap.Add(ECharacterPoseName::Standing_Breathing, StandingBreathingSettings);
    ...
    GCharacterSniper03SequenceSettingsMap.Add(ECharacterPoseName::Aiming_Walking, AimingWalkingSettings);
    ...
    GCharacterSniper03SequenceSettingsMap.Add(ECharacterPoseName::Aiming_Breathing, AimingBreathingSettings);
    ...
    GCharacterSniper03SequenceSettingsMap.Add(ECharacterPoseName::Turning, TurningSettings);
    ...
    GCharacterSniper03SequenceSettingsMap.Add(ECharacterPoseName::Jog, JogSettings);
    ...
    GCharacterSniper03SequenceSettingsMap.Add(ECharacterPoseName::Sprint, SprintSettings);
    ...
    GCharacterSniper03SequenceSettingsMap.Add(ECharacterPoseName::Sprint_Impulse, SprintImpulseSettings);
    ...
    GCharacterSniper03SequenceSettingsMap.Add(ECharacterPoseName::Sprint_Tactical, SprintTacticalSettings);
    ...
    GCharacterSniper03SequenceSettingsMap.Add(ECharacterPoseName::Crouching_Walking, CrouchingWalkingSettings);
}

FCharacterSequenceSettings UCharacterSniper03SequenceSettingsLibrary::GetCharacterSniper03SequenceSettingsByName(ECharacterPoseName SequenceName)
{
