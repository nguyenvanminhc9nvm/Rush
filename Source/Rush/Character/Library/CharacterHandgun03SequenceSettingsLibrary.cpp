...
static TMap<ECharacterSequenceName, FCharacterSequenceSettings> GCharacterHandgun03SequenceSettingsMap;
...
static void InitCharacterHandgun03SequenceSettingsMap()
{
    ...
    GCharacterHandgun03SequenceSettingsMap.Add(ECharacterSequenceName::Standing_Breathing, StandingBreathingSettings);
    ...
    GCharacterHandgun03SequenceSettingsMap.Add(ECharacterSequenceName::Aiming_Walking, AimingWalkingSettings);
    ...
    GCharacterHandgun03SequenceSettingsMap.Add(ECharacterSequenceName::Aiming_Breathing, AimingBreathingSettings);
    ...
    GCharacterHandgun03SequenceSettingsMap.Add(ECharacterSequenceName::Turning, TurningSettings);
    ...
    GCharacterHandgun03SequenceSettingsMap.Add(ECharacterSequenceName::Jog, JogSettings);
    ...
    GCharacterHandgun03SequenceSettingsMap.Add(ECharacterSequenceName::Sprint, SprintSettings);
    ...
    GCharacterHandgun03SequenceSettingsMap.Add(ECharacterSequenceName::Sprint_Impulse, SprintImpulseSettings);
    ...
    GCharacterHandgun03SequenceSettingsMap.Add(ECharacterSequenceName::Sprint_Tactical, SprintTacticalSettings);
    ...
    GCharacterHandgun03SequenceSettingsMap.Add(ECharacterSequenceName::Crouching_Walking, CrouchingWalkingSettings);
}

FCharacterSequenceSettings UCharacterHandgun03SequenceSettingsLibrary::GetCharacterHandgun03SequenceSettingsByName(ECharacterSequenceName SequenceName)
{
