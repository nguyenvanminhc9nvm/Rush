...
static void InitCharacterSniper02MontageSettingsMap()
{
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire, FireSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire_Empty, FireEmptySettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload_Bolt, ReloadBoltSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload_Open, ReloadOpenSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload_Insert, ReloadInsertSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload_Close, ReloadCloseSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect, InspectSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster, HolsterSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster, UnholsterSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterSniper02MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}
...
TArray<FCharacterMontageSettings> UCharacterSniper02MontageSettingsLibrary::GetAllCharacterSniper02MontageSettings()
{
    InitCharacterSniper02MontageSettingsMap();
    TArray<FCharacterMontageSettings> AllSettings;
    GCharacterSniper02MontageSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
