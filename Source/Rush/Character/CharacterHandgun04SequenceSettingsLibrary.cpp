#include "CharacterHandgun04SequenceSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterSequenceName, FCharacterSequenceSettings> GCharacterHandgun04SequenceSettingsMap;

static void InitCharacterHandgun04SequenceSettingsMap()
{
    if (GCharacterHandgun04SequenceSettingsMap.Num() > 0) return;
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterSequenceName::Standing_Breathing, StandingBreathingSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterSequenceName::Aiming_Walking, AimingWalkingSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterSequenceName::Aiming_Breathing, AimingBreathingSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterSequenceName::Turning, TurningSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterSequenceName::Jog, JogSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterSequenceName::Sprint, SprintSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterSequenceName::Sprint_Impulse, SprintImpulseSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterSequenceName::Sprint_Tactical, SprintTacticalSettings);
    ...
    GCharacterHandgun04SequenceSettingsMap.Add(ECharacterSequenceName::Crouching_Walking, CrouchingWalkingSettings);
}

FCharacterSequenceSettings UCharacterHandgun04SequenceSettingsLibrary::GetCharacterHandgun04SequenceSettingsByName(ECharacterSequenceName SequenceName)
{
    InitCharacterHandgun04SequenceSettingsMap();
    if (GCharacterHandgun04SequenceSettingsMap.Contains(SequenceName))
    {
        return GCharacterHandgun04SequenceSettingsMap[SequenceName];
    }
