...
static void InitCharacterGL01Montage02SettingsMap()
{
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Fire, FireSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Fire_Empty, FireEmptySettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Reload, ReloadSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Inspect, InspectSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Holster, HolsterSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Unholster, UnholsterSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterGL01Montage02SettingsMap.Add(ECharacterMontageName::Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}
