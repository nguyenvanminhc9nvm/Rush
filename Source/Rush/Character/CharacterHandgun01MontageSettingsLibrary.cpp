#include "CharacterHandgun01MontageSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterMontageName, FCharacterMontageSettings> GCharacterHandgun01MontageSettingsMap;

static void InitCharacterHandgun01MontageSettingsMap()
{
    if (GCharacterHandgun01MontageSettingsMap.Num() > 0) return;
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire, FireSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire_Empty, FireEmptySettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload, ReloadSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload_Empty, ReloadEmptySettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect, InspectSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster, HolsterSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster, UnholsterSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}

FCharacterMontageSettings UCharacterHandgun01MontageSettingsLibrary::GetCharacterHandgun01MontageSettingsByName(ECharacterMontageName MontageName)
{
    InitCharacterHandgun01MontageSettingsMap();
    if (GCharacterHandgun01MontageSettingsMap.Contains(MontageName))
    {
        return GCharacterHandgun01MontageSettingsMap[MontageName];
    }
    return FCharacterMontageSettings(); // Return default settings if not found
}

TArray<FCharacterMontageSettings> UCharacterHandgun01MontageSettingsLibrary::GetAllCharacterHandgun01MontageSettings()
{
    InitCharacterHandgun01MontageSettingsMap();
    TArray<FCharacterMontageSettings> AllSettings;
    GCharacterHandgun01MontageSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
