...
static void InitCharacterHandgun01MontageSettingsMap()
{
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Fire, FireSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Fire_Empty, FireEmptySettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Reload, ReloadSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Inspect, InspectSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Inspect_Smooth, InspectSmoothSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Holster, HolsterSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Unholster, UnholsterSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Throw_Grenade, ThrowGrenadeSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Throw_Grenade_Additive, ThrowGrenadeAdditiveSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Knife_Attack, KnifeAttackSettings);
    ...
    GCharacterHandgun01MontageSettingsMap.Add(ECharacterMontageName::Knife_Attack_Additive, KnifeAttackAdditiveSettings);
}
