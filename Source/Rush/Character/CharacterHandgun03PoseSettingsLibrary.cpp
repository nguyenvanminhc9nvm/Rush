#include "CharacterHandgun03PoseSettingsLibrary.h"
#include "Engine/Engine.h"

static TMap<ECharacterPoseName, FCharacterPoseSettings> GCharacterHandgun03PoseSettingsMap;

static void InitCharacterHandgun03PoseSettingsMap()
{
    if (GCharacterHandgun03PoseSettingsMap.Num() > 0) return;
    ...
    GCharacterHandgun03PoseSettingsMap.Add(ECharacterPoseName::Idle, IdleSettings);
    ...
    GCharacterHandgun03PoseSettingsMap.Add(ECharacterPoseName::Idle_Walking, IdleWalkingSettings);
    ...
    GCharacterHandgun03PoseSettingsMap.Add(ECharacterPoseName::Idle_Crouch, IdleCrouchSettings);
    ...
    GCharacterHandgun03PoseSettingsMap.Add(ECharacterPoseName::Aim, AimSettings);
    ...
    GCharacterHandgun03PoseSettingsMap.Add(ECharacterPoseName::Aim_Walking, AimWalkingSettings);
    ...
    GCharacterHandgun03PoseSettingsMap.Add(ECharacterPoseName::Aim_Crouch, AimCrouchSettings);
    ...
    GCharacterHandgun03PoseSettingsMap.Add(ECharacterPoseName::Ready, ReadySettings);
    ...
    GCharacterHandgun03PoseSettingsMap.Add(ECharacterPoseName::Ready_Walking, ReadyWalkingSettings);
    ...
    GCharacterHandgun03PoseSettingsMap.Add(ECharacterPoseName::Ready_Crouch, ReadyCrouchSettings);
}

FCharacterPoseSettings UCharacterHandgun03PoseSettingsLibrary::GetCharacterHandgun03PoseSettingsByName(ECharacterPoseName PoseName)
{
    InitCharacterHandgun03PoseSettingsMap();
    if (GCharacterHandgun03PoseSettingsMap.Contains(PoseName))
    {
        return GCharacterHandgun03PoseSettingsMap[PoseName];
    }
    return FCharacterPoseSettings(); // Return default settings if not found
}

TArray<FCharacterPoseSettings> UCharacterHandgun03PoseSettingsLibrary::GetAllCharacterHandgun03PoseSettings()
{
    InitCharacterHandgun03PoseSettingsMap();
    TArray<FCharacterPoseSettings> AllSettings;
    GCharacterHandgun03PoseSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
