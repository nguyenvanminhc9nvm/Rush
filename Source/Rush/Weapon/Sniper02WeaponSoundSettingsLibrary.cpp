...
static void InitSniper02WeaponSoundMap()
{
    ...
    GSniper02WeaponSoundMap.Add(ECharacterMontageName::Jump, JumpSound);
    ...
    GSniper02WeaponSoundMap.Add(ECharacterMontageName::Reload, ReloadSound);
    ...
    GSniper02WeaponSoundMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySound);
    ...
    GSniper02WeaponSoundMap.Add(ECharacterMontageName::Inspect, InspectSound);
    ...
    GSniper02WeaponSoundMap.Add(ECharacterMontageName::Holster, HolsterSound);
    ...
    GSniper02WeaponSoundMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSound);
    ...
    GSniper02WeaponSoundMap.Add(ECharacterMontageName::Unholster, UnholsterSound);
    ...
    GSniper02WeaponSoundMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSound);
}
