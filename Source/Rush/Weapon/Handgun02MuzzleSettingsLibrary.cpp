...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GHandgun02MuzzleSettingsMap;
...
static void InitHandgun02MuzzleSettingsMap()
{
    ...
    GHandgun02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GHandgun02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GHandgun02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GHandgun02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry UHandgun02MuzzleSettingsLibrary::GetHandgun02MuzzleSettingsByName(EMuzzleName MuzzleName)
{
