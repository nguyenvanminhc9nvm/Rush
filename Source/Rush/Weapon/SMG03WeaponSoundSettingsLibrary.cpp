...
static void InitSMG03WeaponSoundMap()
{
    ...
    GSMG03WeaponSoundMap.Add(ECharacterMontageName::Jump, JumpSound);
    ...
    GSMG03WeaponSoundMap.Add(ECharacterMontageName::Reload, ReloadSound);
    ...
    GSMG03WeaponSoundMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySound);
    ...
    GSMG03WeaponSoundMap.Add(ECharacterMontageName::Inspect, InspectSound);
    ...
    GSMG03WeaponSoundMap.Add(ECharacterMontageName::Holster, HolsterSound);
    ...
    GSMG03WeaponSoundMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSound);
    ...
    GSMG03WeaponSoundMap.Add(ECharacterMontageName::Unholster, UnholsterSound);
    ...
    GSMG03WeaponSoundMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSound);
}
