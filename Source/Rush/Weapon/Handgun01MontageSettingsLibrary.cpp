...
static void InitHandgun01MontageSettingsMap()
{
    ...
    GHandgun01MontageSettingsMap.Add(EWeaponMontageName::Weapon_Fire, FireSettings);
    ...
    GHandgun01MontageSettingsMap.Add(EWeaponMontageName::Weapon_Fire_Empty, FireEmptySettings);
    ...
    GHandgun01MontageSettingsMap.Add(EWeaponMontageName::Weapon_Reload, ReloadSettings);
    ...
    GHandgun01MontageSettingsMap.Add(EWeaponMontageName::Weapon_Reload_Empty, ReloadEmptySettings);
    ...
    GHandgun01MontageSettingsMap.Add(EWeaponMontageName::Weapon_Inspect, InspectSettings);
    ...
    GHandgun01MontageSettingsMap.Add(EWeaponMontageName::Weapon_Holster, HolsterSettings);
    ...
    GHandgun01MontageSettingsMap.Add(EWeaponMontageName::Weapon_Unholster, UnholsterSettings);
}
