...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GAR02MuzzleSettingsMap;
...
static void InitAR02MuzzleSettingsMap()
{
    ...
    GAR02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GAR02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GAR02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GAR02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry UAR02MuzzleSettingsLibrary::GetAR02MuzzleSettingsByName(EMuzzleName MuzzleName)
{
