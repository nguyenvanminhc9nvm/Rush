...
static TMap<EMuzzleName, FMuzzleEntry> GMuzzleMap;
...
static void InitMuzzleMap()
{
    ...
    GMuzzleMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
...
TSubclassOf<AActor> UMuzzleBPLibrary::GetMuzzleActorByName(EMuzzleName MuzzleName)
{
    InitMuzzleMap();
    if (GMuzzleMap.Contains(MuzzleName))
    {
