...
static void InitAR02WeaponSoundMap()
{
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Jump, JumpSound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Reload, ReloadSound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Inspect, InspectSound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Holster, HolsterSound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Unholster, UnholsterSound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSound);
}
