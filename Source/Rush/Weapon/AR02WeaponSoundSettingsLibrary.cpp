#include "AR02WeaponSoundSettingsLibrary.h"
#include "Engine/Engine.h"
#include "Sound/SoundCue.h"

static TMap<ECharacterMontageName, FWeaponSound> GAR02WeaponSoundMap;

static void InitAR02WeaponSoundMap()
{
    if (GAR02WeaponSoundMap.Num() > 0) return;
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Jump, JumpSound);

    // Reload
    FWeaponSound ReloadSound = CreateWeaponSound(
        ECharacterMontageName::Character_Montage_Reload,
        0.0f,
        TEXT("/Script/Engine.SoundCue'/Game/Assets/Audio/Cues/Weapons/SC_WEP_AR_02_Reload.SC_WEP_AR_02_Reload'")
    );
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Reload, ReloadSound);

    // Reload-Empty
    FWeaponSound ReloadEmptySound = CreateWeaponSound(
        ECharacterMontageName::Character_Montage_Reload_Empty,
        0.0f,
        TEXT("/Script/Engine.SoundCue'/Game/Assets/Audio/Cues/Weapons/SC_WEP_AR_02_Reload_Empty.SC_WEP_AR_02_Reload_Empty'")
    );
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Reload_Empty, ReloadEmptySound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Inspect, InspectSound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Holster, HolsterSound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Holster_Smooth, HolsterSmoothSound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Unholster, UnholsterSound);
    ...
    GAR02WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Unholster_Smooth, UnholsterSmoothSound);
}

FWeaponSound UAR02WeaponSoundSettingsLibrary::GetWeaponSoundByName(ECharacterMontageName SoundName)
{
    InitAR02WeaponSoundMap();
    
    if (FWeaponSound* FoundSound = GAR02WeaponSoundMap.Find(SoundName))
    {
        return *FoundSound;
    }
...
TArray<FWeaponSound> UAR02WeaponSoundSettingsLibrary::GetAllAR02WeaponSounds()
{
    InitAR02WeaponSoundMap();
    TArray<FWeaponSound> AllSounds;
    GAR02WeaponSoundMap.GenerateValueArray(AllSounds);
    return AllSounds;
}
