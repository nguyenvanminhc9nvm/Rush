#include "SMG01MuzzleSettingsLibrary.h"
#include "Engine/Engine.h"
#include "Particles/ParticleSystem.h"
#include "Rush/Weapon/Enum/EWeaponIconName.h"
#include "Sound/SoundCue.h"

static TMap<EWeaponIconName, FMuzzleSettingsEntry> GSMG01MuzzleSettingsMap;

static void InitSMG01MuzzleSettingsMap()
{
    if (GSMG01MuzzleSettingsMap.Num() > 0) return;
    ...
    HiddenEntry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_01_Fire.SC_WEP_SMG_01_Fire"));
    ...
    HiddenEntry.FlashLightRelativeLocation = FVector(8.0f, 100.0f, -5.0f); // SMG specific positioning
    
    GSMG01MuzzleSettingsMap.Add(EWeaponIconName::NoneHidden, HiddenEntry);
    ...
    Silencer01Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_01_Fire_Suppressed_01.SC_WEP_SMG_01_Fire_Suppressed_01"));
    ...
    GSMG01MuzzleSettingsMap.Add(EWeaponIconName::Silencer_01, Silencer01Entry);
    ...
    Silencer02Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_01_Fire_Suppressed_02.SC_WEP_SMG_01_Fire_Suppressed_02"));
    ...
    GSMG01MuzzleSettingsMap.Add(EWeaponIconName::Silencer_02, Silencer02Entry);
    ...
    Silencer03Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_01_Fire_Suppressed_03.SC_WEP_SMG_01_Fire_Suppressed_03"));
    ...
    GSMG01MuzzleSettingsMap.Add(EWeaponIconName::Silencer_03, Silencer03Entry);
}

FMuzzleSettingsEntry USMG01MuzzleSettingsLibrary::GetSMG01MuzzleSettingsByName(EWeaponIconName MuzzleName)
{
    InitSMG01MuzzleSettingsMap();
    if (GSMG01MuzzleSettingsMap.Contains(MuzzleName))
    {
        return GSMG01MuzzleSettingsMap[MuzzleName];
    }
