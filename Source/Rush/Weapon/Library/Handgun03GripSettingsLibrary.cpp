...
static TMap<EWeaponIconName, FGripSettingsEntry> GHandgun03GripSettingsMap;
...
static void InitHandgun03GripSettingsMap()
{
    ...
    GHandgun03GripSettingsMap.Add(EWeaponIconName::Grip_01, Grip01Entry);
    ...
    GHandgun03GripSettingsMap.Add(EWeaponIconName::Bipod_01, Bipod01Entry);
    ...
    GHandgun03GripSettingsMap.Add(EWeaponIconName::Bipod_02, Bipod02Entry);
}

FGripSettingsEntry UHandgun03GripSettingsLibrary::GetHandgun03GripSettingsByName(EWeaponIconName GripName)
{
