...
static TMap<EWeaponIconName, FGripSettingsEntry> GSMG02GripSettingsMap;
...
static void InitSMG02GripSettingsMap()
{
    ...
    GSMG02GripSettingsMap.Add(EWeaponIconName::Grip_01, Grip01Entry);
    ...
    GSMG02GripSettingsMap.Add(EWeaponIconName::Bipod_01, Bipod01Entry);
    ...
    GSMG02GripSettingsMap.Add(EWeaponIconName::Bipod_02, Bipod02Entry);
}

FGripSettingsEntry USMG02GripSettingsLibrary::GetSMG02GripSettingsByName(EWeaponIconName GripName)
{
