#include "Handgun03MuzzleSettingsLibrary.h"
#include "Engine/Engine.h"
#include "Particles/ParticleSystem.h"
#include "Rush/Weapon/Enum/EWeaponIconName.h"
#include "Sound/SoundCue.h"

static TMap<EWeaponIconName, FMuzzleSettingsEntry> GHandgun03MuzzleSettingsMap;

static void InitHandgun03MuzzleSettingsMap()
{
    if (GHandgun03MuzzleSettingsMap.Num() > 0) return;
    ...
    HiddenEntry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Handgun_03_Fire.SC_WEP_Handgun_03_Fire"));
    ...
    HiddenEntry.FlashLightRelativeLocation = FVector(8.0f, 65.0f, 0.0f); // Same as other handguns
    
    GHandgun03MuzzleSettingsMap.Add(EWeaponIconName::NoneHidden, HiddenEntry);
    ...
    Silencer01Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Handgun_03_Fire_Suppressed_01.SC_WEP_Handgun_03_Fire_Suppressed_01"));
    ...
    GHandgun03MuzzleSettingsMap.Add(EWeaponIconName::Silencer_01, Silencer01Entry);
    ...
    Silencer02Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Handgun_03_Fire_Suppressed_02.SC_WEP_Handgun_03_Fire_Suppressed_02"));
    ...
    GHandgun03MuzzleSettingsMap.Add(EWeaponIconName::Silencer_02, Silencer02Entry);
    ...
    Silencer03Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Handgun_03_Fire_Suppressed_03.SC_WEP_Handgun_03_Fire_Suppressed_03"));
    ...
    GHandgun03MuzzleSettingsMap.Add(EWeaponIconName::Silencer_03, Silencer03Entry);
}

FMuzzleSettingsEntry UHandgun03MuzzleSettingsLibrary::GetHandgun03MuzzleSettingsByName(EWeaponIconName MuzzleName)
{
    InitHandgun03MuzzleSettingsMap();
    if (GHandgun03MuzzleSettingsMap.Contains(MuzzleName))
    {
        return GHandgun03MuzzleSettingsMap[MuzzleName];
    }
    return FMuzzleSettingsEntry();
}

TArray<FMuzzleSettingsEntry> UHandgun03MuzzleSettingsLibrary::GetAllHandgun03MuzzleSettings()
{
    InitHandgun03MuzzleSettingsMap();
    TArray<FMuzzleSettingsEntry> AllSettings;
    GHandgun03MuzzleSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
