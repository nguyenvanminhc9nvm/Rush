...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GHandgun03MuzzleSettingsMap;
...
static void InitHandgun03MuzzleSettingsMap()
{
    ...
    GHandgun03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GHandgun03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GHandgun03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GHandgun03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry UHandgun03MuzzleSettingsLibrary::GetHandgun03MuzzleSettingsByName(EMuzzleName MuzzleName)
{
