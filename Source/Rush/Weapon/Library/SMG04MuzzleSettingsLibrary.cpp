...
static TMap<EWeaponIconName, FMuzzleSettingsEntry> GSMG04MuzzleSettingsMap;
...
static void InitSMG04MuzzleSettingsMap()
{
    ...
    GSMG04MuzzleSettingsMap.Add(EWeaponIconName::NoneHidden, HiddenEntry);
    ...
    GSMG04MuzzleSettingsMap.Add(EWeaponIconName::Silencer_01, Silencer01Entry);
    ...
    GSMG04MuzzleSettingsMap.Add(EWeaponIconName::Silencer_02, Silencer02Entry);
    ...
    GSMG04MuzzleSettingsMap.Add(EWeaponIconName::Silencer_03, Silencer03Entry);
}

FMuzzleSettingsEntry USMG04MuzzleSettingsLibrary::GetSMG04MuzzleSettingsByName(EWeaponIconName MuzzleName)
{
