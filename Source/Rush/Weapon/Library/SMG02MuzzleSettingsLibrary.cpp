#include "SMG02MuzzleSettingsLibrary.h"
#include "Engine/Engine.h"
#include "Particles/ParticleSystem.h"
#include "Rush/Weapon/Enum/EWeaponIconName.h"
#include "Sound/SoundCue.h"

static TMap<EWeaponIconName, FMuzzleSettingsEntry> GSMG02MuzzleSettingsMap;

static void InitSMG02MuzzleSettingsMap()
{
    if (GSMG02MuzzleSettingsMap.Num() > 0) return;
    ...
    HiddenEntry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_02_Fire.SC_WEP_SMG_02_Fire"));
    ...
    HiddenEntry.FlashLightRelativeLocation = FVector(8.0f, 100.0f, -5.0f); // Same as SMG01
    
    GSMG02MuzzleSettingsMap.Add(EWeaponIconName::NoneHidden, HiddenEntry);
    ...
    Silencer01Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_02_Fire_Suppressed_01.SC_WEP_SMG_02_Fire_Suppressed_01"));
    ...
    GSMG02MuzzleSettingsMap.Add(EWeaponIconName::Silencer_01, Silencer01Entry);
    ...
    Silencer02Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_02_Fire_Suppressed_02.SC_WEP_SMG_02_Fire_Suppressed_02"));
    ...
    GSMG02MuzzleSettingsMap.Add(EWeaponIconName::Silencer_02, Silencer02Entry);
    ...
    Silencer03Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_02_Fire_Suppressed_03.SC_WEP_SMG_02_Fire_Suppressed_03"));
    ...
    GSMG02MuzzleSettingsMap.Add(EWeaponIconName::Silencer_03, Silencer03Entry);
}

FMuzzleSettingsEntry USMG02MuzzleSettingsLibrary::GetSMG02MuzzleSettingsByName(EWeaponIconName MuzzleName)
{
    InitSMG02MuzzleSettingsMap();
    if (GSMG02MuzzleSettingsMap.Contains(MuzzleName))
    {
        return GSMG02MuzzleSettingsMap[MuzzleName];
    }
