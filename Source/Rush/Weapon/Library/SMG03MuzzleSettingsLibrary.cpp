...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GSMG03MuzzleSettingsMap;
...
static void InitSMG03MuzzleSettingsMap()
{
    ...
    GSMG03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GSMG03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GSMG03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GSMG03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry USMG03MuzzleSettingsLibrary::GetSMG03MuzzleSettingsByName(EMuzzleName MuzzleName)
{
