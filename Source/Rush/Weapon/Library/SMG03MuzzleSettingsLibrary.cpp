#include "SMG03MuzzleSettingsLibrary.h"
#include "Engine/Engine.h"
#include "Particles/ParticleSystem.h"
#include "Rush/Weapon/Enum/EWeaponIconName.h"
#include "Sound/SoundCue.h"

static TMap<EWeaponIconName, FMuzzleSettingsEntry> GSMG03MuzzleSettingsMap;

static void InitSMG03MuzzleSettingsMap()
{
    if (GSMG03MuzzleSettingsMap.Num() > 0) return;
    ...
    HiddenEntry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_03_Fire.SC_WEP_SMG_03_Fire"));
    ...
    HiddenEntry.FlashLightRelativeLocation = FVector(8.0f, 100.0f, -5.0f); // Same as SMG01 and SMG02
    
    GSMG03MuzzleSettingsMap.Add(EWeaponIconName::NoneHidden, HiddenEntry);
    ...
    Silencer01Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_03_Fire_Suppressed_01.SC_WEP_SMG_03_Fire_Suppressed_01"));
    ...
    GSMG03MuzzleSettingsMap.Add(EWeaponIconName::Silencer_01, Silencer01Entry);
    ...
    Silencer02Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_03_Fire_Suppressed_02.SC_WEP_SMG_03_Fire_Suppressed_02"));
    ...
    GSMG03MuzzleSettingsMap.Add(EWeaponIconName::Silencer_02, Silencer02Entry);
    ...
    Silencer03Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_SMG_03_Fire_Suppressed_03.SC_WEP_SMG_03_Fire_Suppressed_03"));
    ...
    GSMG03MuzzleSettingsMap.Add(EWeaponIconName::Silencer_03, Silencer03Entry);
}

FMuzzleSettingsEntry USMG03MuzzleSettingsLibrary::GetSMG03MuzzleSettingsByName(EWeaponIconName MuzzleName)
{
    InitSMG03MuzzleSettingsMap();
    if (GSMG03MuzzleSettingsMap.Contains(MuzzleName))
    {
        return GSMG03MuzzleSettingsMap[MuzzleName];
    }
    return FMuzzleSettingsEntry();
}

TArray<FMuzzleSettingsEntry> USMG03MuzzleSettingsLibrary::GetAllSMG03MuzzleSettings()
{
    InitSMG03MuzzleSettingsMap();
    TArray<FMuzzleSettingsEntry> AllSettings;
    GSMG03MuzzleSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
