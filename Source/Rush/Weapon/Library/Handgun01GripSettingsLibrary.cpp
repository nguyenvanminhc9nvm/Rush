...
static TMap<EWeaponIconName, FGripSettingsEntry> GHandgun01GripSettingsMap;
...
static void InitHandgun01GripSettingsMap()
{
    ...
    GHandgun01GripSettingsMap.Add(EWeaponIconName::Grip_01, Grip01Entry);
    ...
    GHandgun01GripSettingsMap.Add(EWeaponIconName::Bipod_01, Bipod01Entry);
    ...
    GHandgun01GripSettingsMap.Add(EWeaponIconName::Bipod_02, Bipod02Entry);
}

FGripSettingsEntry UHandgun01GripSettingsLibrary::GetHandgun01GripSettingsByName(EWeaponIconName GripName)
{
