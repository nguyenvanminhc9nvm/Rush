...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GHandgun04MuzzleSettingsMap;
...
static void InitHandgun04MuzzleSettingsMap()
{
    ...
    GHandgun04MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GHandgun04MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GHandgun04MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GHandgun04MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry UHandgun04MuzzleSettingsLibrary::GetHandgun04MuzzleSettingsByName(EMuzzleName MuzzleName)
{
