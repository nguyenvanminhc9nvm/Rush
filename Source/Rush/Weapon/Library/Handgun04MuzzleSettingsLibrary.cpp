#include "Handgun04MuzzleSettingsLibrary.h"
#include "Engine/Engine.h"
#include "Particles/ParticleSystem.h"
#include "Rush/Weapon/Enum/EWeaponIconName.h"
#include "Sound/SoundCue.h"

static TMap<EWeaponIconName, FMuzzleSettingsEntry> GHandgun04MuzzleSettingsMap;

static void InitHandgun04MuzzleSettingsMap()
{
    if (GHandgun04MuzzleSettingsMap.Num() > 0) return;
    ...
    HiddenEntry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Handgun_04_Fire.SC_WEP_Handgun_04_Fire"));
    ...
    GHandgun04MuzzleSettingsMap.Add(EWeaponIconName::NoneHidden, HiddenEntry);
    ...
    Silencer01Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Handgun_04_Fire_Suppressed_01.SC_WEP_Handgun_04_Fire_Suppressed_01"));
    ...
    GHandgun04MuzzleSettingsMap.Add(EWeaponIconName::Silencer_01, Silencer01Entry);
    ...
    Silencer02Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Handgun_04_Fire_Suppressed_02.SC_WEP_Handgun_04_Fire_Suppressed_02"));
    ...
    GHandgun04MuzzleSettingsMap.Add(EWeaponIconName::Silencer_02, Silencer02Entry);
    ...
    Silencer03Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Handgun_04_Fire_Suppressed_03.SC_WEP_Handgun_04_Fire_Suppressed_03"));
    ...
    GHandgun04MuzzleSettingsMap.Add(EWeaponIconName::Silencer_03, Silencer03Entry);
}

FMuzzleSettingsEntry UHandgun04MuzzleSettingsLibrary::GetHandgun04MuzzleSettingsByName(EWeaponIconName MuzzleName)
{
    InitHandgun04MuzzleSettingsMap();
    if (GHandgun04MuzzleSettingsMap.Contains(MuzzleName))
    {
        return GHandgun04MuzzleSettingsMap[MuzzleName];
    }
    return FMuzzleSettingsEntry();
}

TArray<FMuzzleSettingsEntry> UHandgun04MuzzleSettingsLibrary::GetAllHandgun04MuzzleSettings()
{
    InitHandgun04MuzzleSettingsMap();
    TArray<FMuzzleSettingsEntry> AllSettings;
    GHandgun04MuzzleSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
