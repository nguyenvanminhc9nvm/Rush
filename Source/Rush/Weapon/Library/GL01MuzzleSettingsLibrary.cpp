#include "GL01MuzzleSettingsLibrary.h"
#include "Engine/Engine.h"
#include "Particles/ParticleSystem.h"
#include "Rush/Weapon/Enum/EWeaponIconName.h"
#include "Sound/SoundCue.h"

static TMap<EWeaponIconName, FMuzzleSettingsEntry> GGL01MuzzleSettingsMap;

static void InitGL01MuzzleSettingsMap()
{
    if (GGL01MuzzleSettingsMap.Num() > 0) return;
    ...
    HiddenEntry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_GL_01_Fire.SC_WEP_GL_01_Fire"));
    ...
    HiddenEntry.FlashLightRelativeLocation = FVector(8.0f, 100.0f, -5.0f); // Different values for grenade launcher
    
    GGL01MuzzleSettingsMap.Add(EWeaponIconName::NoneHidden, HiddenEntry);
    ...
    Silencer01Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_GL_01_Fire_Suppressed_01.SC_WEP_GL_01_Fire_Suppressed_01"));
    ...
    GGL01MuzzleSettingsMap.Add(EWeaponIconName::Silencer_01, Silencer01Entry);
    ...
    Silencer02Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_GL_01_Fire_Suppressed_02.SC_WEP_GL_01_Fire_Suppressed_02"));
    ...
    GGL01MuzzleSettingsMap.Add(EWeaponIconName::Silencer_02, Silencer02Entry);
    ...
    Silencer03Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_GL_01_Fire_Suppressed_03.SC_WEP_GL_01_Fire_Suppressed_03"));
    ...
    GGL01MuzzleSettingsMap.Add(EWeaponIconName::Silencer_03, Silencer03Entry);
}

FMuzzleSettingsEntry UGL01MuzzleSettingsLibrary::GetGL01MuzzleSettingsByName(EWeaponIconName MuzzleName)
{
    InitGL01MuzzleSettingsMap();
    if (GGL01MuzzleSettingsMap.Contains(MuzzleName))
    {
        return GGL01MuzzleSettingsMap[MuzzleName];
    }
