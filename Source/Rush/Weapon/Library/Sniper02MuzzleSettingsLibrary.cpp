...
static TMap<EWeaponIconName, FMuzzleSettingsEntry> GSniper02MuzzleSettingsMap;
...
static void InitSniper02MuzzleSettingsMap()
{
    ...
    GSniper02MuzzleSettingsMap.Add(EWeaponIconName::NoneHidden, HiddenEntry);
    ...
    GSniper02MuzzleSettingsMap.Add(EWeaponIconName::Silencer_01, Silencer01Entry);
    ...
    GSniper02MuzzleSettingsMap.Add(EWeaponIconName::Silencer_02, Silencer02Entry);
    ...
    GSniper02MuzzleSettingsMap.Add(EWeaponIconName::Silencer_03, Silencer03Entry);
}

FMuzzleSettingsEntry USniper02MuzzleSettingsLibrary::GetSniper02MuzzleSettingsByName(EWeaponIconName MuzzleName)
{
...
TArray<FMuzzleSettingsEntry> USniper02MuzzleSettingsLibrary::GetAllSniper02MuzzleSettings()
{
    InitSniper02MuzzleSettingsMap();
    TArray<FMuzzleSettingsEntry> AllSettings;
    GSniper02MuzzleSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
