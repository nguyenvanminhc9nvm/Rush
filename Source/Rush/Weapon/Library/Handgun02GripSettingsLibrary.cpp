...
static TMap<EGripName, FGripSettingsEntry> GHandgun02GripSettingsMap;
...
static void InitHandgun02GripSettingsMap()
{
    ...
    GHandgun02GripSettingsMap.Add(EGripName::Grip01, Grip01Entry);
    ...
    GHandgun02GripSettingsMap.Add(EGripName::Bipod01, Bipod01Entry);
    ...
    GHandgun02GripSettingsMap.Add(EGripName::Bipod02, Bipod02Entry);
}

FGripSettingsEntry UHandgun02GripSettingsLibrary::GetHandgun02GripSettingsByName(EGripName GripName)
{
