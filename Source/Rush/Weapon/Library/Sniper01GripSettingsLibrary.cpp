...
static TMap<EWeaponIconName, FGripSettingsEntry> GSniper01GripSettingsMap;
...
static void InitSniper01GripSettingsMap()
{
    ...
    GSniper01GripSettingsMap.Add(EWeaponIconName::Grip_01, Grip01Entry);
    ...
    GSniper01GripSettingsMap.Add(EWeaponIconName::Bipod_01, Bipod01Entry);
    ...
    GSniper01GripSettingsMap.Add(EWeaponIconName::Bipod_02, Bipod02Entry);
}

FGripSettingsEntry USniper01GripSettingsLibrary::GetSniper01GripSettingsByName(EWeaponIconName GripName)
{
