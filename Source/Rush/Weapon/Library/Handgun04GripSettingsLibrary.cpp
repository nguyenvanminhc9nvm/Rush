...
static TMap<EWeaponIconName, FGripSettingsEntry> GHandgun04GripSettingsMap;
...
static void InitHandgun04GripSettingsMap()
{
    ...
    GHandgun04GripSettingsMap.Add(EWeaponIconName::Grip_01, Grip01Entry);
    ...
    GHandgun04GripSettingsMap.Add(EWeaponIconName::Bipod_01, Bipod01Entry);
    ...
    GHandgun04GripSettingsMap.Add(EWeaponIconName::Bipod_02, Bipod02Entry);
}

FGripSettingsEntry UHandgun04GripSettingsLibrary::GetHandgun04GripSettingsByName(EWeaponIconName GripName)
{
