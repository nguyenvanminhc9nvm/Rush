#include "AR02MuzzleSettingsLibrary.h"
#include "Engine/Engine.h"
#include "Particles/ParticleSystem.h"
#include "Rush/Weapon/Enum/EWeaponIconName.h"
#include "Sound/SoundCue.h"

static TMap<EWeaponIconName, FMuzzleSettingsEntry> GAR02MuzzleSettingsMap;

static void InitAR02MuzzleSettingsMap()
{
    if (GAR02MuzzleSettingsMap.Num() > 0) return;
    ...
    HiddenEntry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_AR_02_Fire.SC_WEP_AR_02_Fire"));
    ...
    GAR02MuzzleSettingsMap.Add(EWeaponIconName::NoneHidden, HiddenEntry);
    ...
    Silencer01Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_AR_02_Fire_Suppressed_01.SC_WEP_AR_02_Fire_Suppressed_01"));
    ...
    GAR02MuzzleSettingsMap.Add(EWeaponIconName::Silencer_01, Silencer01Entry);
    ...
    Silencer02Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_AR_02_Fire_Suppressed_02.SC_WEP_AR_02_Fire_Suppressed_02"));
    ...
    GAR02MuzzleSettingsMap.Add(EWeaponIconName::Silencer_02, Silencer02Entry);
    ...
    Silencer03Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_AR_02_Fire_Suppressed_03.SC_WEP_AR_02_Fire_Suppressed_03"));
    ...
    GAR02MuzzleSettingsMap.Add(EWeaponIconName::Silencer_03, Silencer03Entry);
}

FMuzzleSettingsEntry UAR02MuzzleSettingsLibrary::GetAR02MuzzleSettingsByName(EWeaponIconName MuzzleName)
{
    InitAR02MuzzleSettingsMap();
    if (GAR02MuzzleSettingsMap.Contains(MuzzleName))
    {
        return GAR02MuzzleSettingsMap[MuzzleName];
    }
