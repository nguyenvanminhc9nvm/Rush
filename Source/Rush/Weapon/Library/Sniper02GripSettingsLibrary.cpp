...
static TMap<EWeaponIconName, FGripSettingsEntry> GSniper02GripSettingsMap;
...
static void InitSniper02GripSettingsMap()
{
    ...
    GSniper02GripSettingsMap.Add(EWeaponIconName::Grip_01, Grip01Entry);
    ...
    GSniper02GripSettingsMap.Add(EWeaponIconName::Bipod_01, Bipod01Entry);
    ...
    GSniper02GripSettingsMap.Add(EWeaponIconName::Bipod_02, Bipod02Entry);
}

FGripSettingsEntry USniper02GripSettingsLibrary::GetSniper02GripSettingsByName(EWeaponIconName GripName)
{
