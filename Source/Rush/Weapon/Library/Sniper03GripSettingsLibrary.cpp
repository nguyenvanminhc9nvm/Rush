...
static TMap<EWeaponIconName, FGripSettingsEntry> GSniper03GripSettingsMap;
...
static void InitSniper03GripSettingsMap()
{
    ...
    GSniper03GripSettingsMap.Add(EWeaponIconName::Grip_01, Grip01Entry);
    ...
    GSniper03GripSettingsMap.Add(EWeaponIconName::Bipod_01, Bipod01Entry);
    ...
    GSniper03GripSettingsMap.Add(EWeaponIconName::Bipod_02, Bipod02Entry);
}

FGripSettingsEntry USniper03GripSettingsLibrary::GetSniper03GripSettingsByName(EWeaponIconName GripName)
{
...
TArray<FGripSettingsEntry> USniper03GripSettingsLibrary::GetAllSniper03GripSettings()
{
    InitSniper03GripSettingsMap();
    TArray<FGripSettingsEntry> AllSettings;
    GSniper03GripSettingsMap.GenerateValueArray(AllSettings);
    return AllSettings;
}
