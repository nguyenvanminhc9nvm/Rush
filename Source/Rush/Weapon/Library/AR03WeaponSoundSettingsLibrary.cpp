...
static void InitAR03WeaponSoundMap()
{
    ...
    GAR03WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Jump, JumpSound);
    ...
    GAR03WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Reload, ReloadSound);
    ...
    GAR03WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Reload_Empty, ReloadEmptySound);
    ...
    GAR03WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Inspect, InspectSound);
    ...
    GAR03WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Holster, HolsterSound);
    ...
    GAR03WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Holster_Smooth, HolsterSmoothSound);
    ...
    GAR03WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Unholster, UnholsterSound);
    ...
    GAR03WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Unholster_Smooth, UnholsterSmoothSound);
}
...
TArray<FWeaponSound> UAR03WeaponSoundSettingsLibrary::GetAllAR03WeaponSounds()
{
    InitAR03WeaponSoundMap();
    TArray<FWeaponSound> AllSounds;
    GAR03WeaponSoundMap.GenerateValueArray(AllSounds);
    return AllSounds;
}
