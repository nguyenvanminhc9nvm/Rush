...
static TMap<ECharacterMontageName, FWeaponMontageSettings> GSMG04MontageSettingsMap;
...
static void InitSMG04MontageSettingsMap()
{
    ...
    GSMG04MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire, FireSettings);
    ...
    GSMG04MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Fire_Empty, FireEmptySettings);
    ...
    GSMG04MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload, ReloadSettings);
    ...
    GSMG04MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Reload_Empty, ReloadEmptySettings);
    ...
    GSMG04MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Inspect, InspectSettings);
    ...
    GSMG04MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Holster, HolsterSettings);
    ...
    GSMG04MontageSettingsMap.Add(ECharacterMontageName::Character_Montage_Unholster, UnholsterSettings);
}

FWeaponMontageSettings USMG04MontageSettingsLibrary::GetSMG04MontageSettingsByName(ECharacterMontageName MontageName)
{
