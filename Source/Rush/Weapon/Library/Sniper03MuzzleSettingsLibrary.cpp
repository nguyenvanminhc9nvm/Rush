#include "Sniper03MuzzleSettingsLibrary.h"
#include "Engine/Engine.h"
#include "Particles/ParticleSystem.h"
#include "Rush/Weapon/Enum/EWeaponIconName.h"
#include "Sound/SoundCue.h"

static TMap<EWeaponIconName, FMuzzleSettingsEntry> GSniper03MuzzleSettingsMap;

static void InitSniper03MuzzleSettingsMap()
{
    if (GSniper03MuzzleSettingsMap.Num() > 0) return;
    ...
    HiddenEntry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Sniper_03_Fire.SC_WEP_Sniper_03_Fire"));
    ...
    HiddenEntry.FlashLightDuration = 0.04f; // Same as Sniper02
    HiddenEntry.FlashLightRelativeLocation = FVector(8.0f, 100.0f, -5.0f); // Same positioning as Sniper02
    
    GSniper03MuzzleSettingsMap.Add(EWeaponIconName::NoneHidden, HiddenEntry);
    ...
    Silencer01Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Sniper_03_Fire_Suppressed_01.SC_WEP_Sniper_03_Fire_Suppressed_01"));
    ...
    GSniper03MuzzleSettingsMap.Add(EWeaponIconName::Silencer_01, Silencer01Entry);
    ...
    Silencer02Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Sniper_03_Fire_Suppressed_02.SC_WEP_Sniper_03_Fire_Suppressed_02"));
    ...
    GSniper03MuzzleSettingsMap.Add(EWeaponIconName::Silencer_02, Silencer02Entry);
    ...
    Silencer03Entry.FireSoundCue = LoadObject<USoundCue>(nullptr, TEXT("/Game/Assets/Audio/Cues/Weapons/SC_WEP_Sniper_03_Fire_Suppressed_03.SC_WEP_Sniper_03_Fire_Suppressed_03"));
    ...
    GSniper03MuzzleSettingsMap.Add(EWeaponIconName::Silencer_03, Silencer03Entry);
}

FMuzzleSettingsEntry USniper03MuzzleSettingsLibrary::GetSniper03MuzzleSettingsByName(EWeaponIconName MuzzleName)
{
    InitSniper03MuzzleSettingsMap();
    if (GSniper03MuzzleSettingsMap.Contains(MuzzleName))
    {
        return GSniper03MuzzleSettingsMap[MuzzleName];
    }
