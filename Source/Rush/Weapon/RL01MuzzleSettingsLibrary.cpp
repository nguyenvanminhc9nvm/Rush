...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GRL01MuzzleSettingsMap;
...
static void InitRL01MuzzleSettingsMap()
{
    ...
    GRL01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GRL01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GRL01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GRL01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry URL01MuzzleSettingsLibrary::GetRL01MuzzleSettingsByName(EMuzzleName MuzzleName)
{
