...
static void InitSMG04WeaponSoundMap()
{
    ...
    GSMG04WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Jump, JumpSound);
    ...
    GSMG04WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Reload, ReloadSound);
    ...
    GSMG04WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Reload_Empty, ReloadEmptySound);
    ...
    GSMG04WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Inspect, InspectSound);
    ...
    GSMG04WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Holster, HolsterSound);
    ...
    GSMG04WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Holster_Smooth, HolsterSmoothSound);
    ...
    GSMG04WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Unholster, UnholsterSound);
    ...
    GSMG04WeaponSoundMap.Add(ECharacterMontageName::Character_Montage_Unholster_Smooth, UnholsterSmoothSound);
}
...
TArray<FWeaponSound> USMG04WeaponSoundSettingsLibrary::GetAllSMG04WeaponSounds()
{
    InitSMG04WeaponSoundMap();
    TArray<FWeaponSound> AllSounds;
    GSMG04WeaponSoundMap.GenerateValueArray(AllSounds);
    return AllSounds;
}
