...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GSMG02MuzzleSettingsMap;
...
static void InitSMG02MuzzleSettingsMap()
{
    ...
    GSMG02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GSMG02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GSMG02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GSMG02MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry USMG02MuzzleSettingsLibrary::GetSMG02MuzzleSettingsByName(EMuzzleName MuzzleName)
{
