...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GAR03MuzzleSettingsMap;
...
static void InitAR03MuzzleSettingsMap()
{
    ...
    GAR03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GAR03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GAR03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GAR03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry UAR03MuzzleSettingsLibrary::GetAR03MuzzleSettingsByName(EMuzzleName MuzzleName)
{
