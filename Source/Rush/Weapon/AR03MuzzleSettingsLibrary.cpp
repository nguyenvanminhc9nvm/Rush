...
static void InitAR03MuzzleSettingsMap()
{
    ...
    GAR03MuzzleSettingsMap.Add(EMuzzleName::Silencer01, Silencer01Entry);
    ...
    GAR03MuzzleSettingsMap.Add(EMuzzleName::Silencer02, Silencer02Entry);
    ...
    GAR03MuzzleSettingsMap.Add(EMuzzleName::Silencer03, Silencer03Entry);
}
