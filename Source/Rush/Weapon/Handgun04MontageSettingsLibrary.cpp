...
static void InitHandgun04MontageSettingsMap()
{
    ...
    GHandgun04MontageSettingsMap.Add(EWeaponMontageName::Fire, FireSettings);
    ...
    GHandgun04MontageSettingsMap.Add(EWeaponMontageName::Fire_Empty, FireEmptySettings);
    ...
    GHandgun04MontageSettingsMap.Add(EWeaponMontageName::Reload, ReloadSettings);
    ...
    GHandgun04MontageSettingsMap.Add(EWeaponMontageName::Reload_Empty, ReloadEmptySettings);
    ...
    GHandgun04MontageSettingsMap.Add(EWeaponMontageName::Inspect, InspectSettings);
    ...
    GHandgun04MontageSettingsMap.Add(EWeaponMontageName::Holster, HolsterSettings);
    ...
    GHandgun04MontageSettingsMap.Add(EWeaponMontageName::Unholster, UnholsterSettings);
}
