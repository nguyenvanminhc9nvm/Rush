...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GGL01MuzzleSettingsMap;
...
static void InitGL01MuzzleSettingsMap()
{
    ...
    GGL01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GGL01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GGL01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GGL01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry UGL01MuzzleSettingsLibrary::GetGL01MuzzleSettingsByName(EMuzzleName MuzzleName)
{
