...
static void InitSMG02WeaponSoundMap()
{
    ...
    GSMG02WeaponSoundMap.Add(ECharacterMontageName::Jump, JumpSound);
    ...
    GSMG02WeaponSoundMap.Add(ECharacterMontageName::Reload, ReloadSound);
    ...
    GSMG02WeaponSoundMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySound);
    ...
    GSMG02WeaponSoundMap.Add(ECharacterMontageName::Inspect, InspectSound);
    ...
    GSMG02WeaponSoundMap.Add(ECharacterMontageName::Holster, HolsterSound);
    ...
    GSMG02WeaponSoundMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSound);
    ...
    GSMG02WeaponSoundMap.Add(ECharacterMontageName::Unholster, UnholsterSound);
    ...
    GSMG02WeaponSoundMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSound);
}
