...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GSMG01MuzzleSettingsMap;
...
static void InitSMG01MuzzleSettingsMap()
{
    ...
    GSMG01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GSMG01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GSMG01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GSMG01MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry USMG01MuzzleSettingsLibrary::GetSMG01MuzzleSettingsByName(EMuzzleName MuzzleName)
{
