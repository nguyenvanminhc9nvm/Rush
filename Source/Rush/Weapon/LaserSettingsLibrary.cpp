...
static void InitLaserSettingsMap()
{
    ...
    HiddenEntry.Name = EFragmentLaserName::Laser_Hidden;
    ...
    GLaserSettingsMap.Add(EFragmentLaserName::Laser_Hidden, HiddenEntry);

    // Flashlight
    FLaserSettingsEntry FlashlightEntry;
    FlashlightEntry.Name = EFragmentLaserName::Flashlight;
    ...
    GLaserSettingsMap.Add(EFragmentLaserName::Flashlight, FlashlightEntry);
    
    // Lasersight
    FLaserSettingsEntry LasersightEntry;
    LasersightEntry.Name = EFragmentLaserName::LaserSight;
    ...
    GLaserSettingsMap.Add(EFragmentLaserName::LaserSight, LasersightEntry);
}
