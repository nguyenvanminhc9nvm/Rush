...
static void InitSMG01WeaponSoundMap()
{
    ...
    GSMG01WeaponSoundMap.Add(ECharacterMontageName::Jump, JumpSound);
    ...
    GSMG01WeaponSoundMap.Add(ECharacterMontageName::Reload, ReloadSound);
    ...
    GSMG01WeaponSoundMap.Add(ECharacterMontageName::Reload_Empty, ReloadEmptySound);
    ...
    GSMG01WeaponSoundMap.Add(ECharacterMontageName::Inspect, InspectSound);
    ...
    GSMG01WeaponSoundMap.Add(ECharacterMontageName::Holster, HolsterSound);
    ...
    GSMG01WeaponSoundMap.Add(ECharacterMontageName::Holster_Smooth, HolsterSmoothSound);
    ...
    GSMG01WeaponSoundMap.Add(ECharacterMontageName::Unholster, UnholsterSound);
    ...
    GSMG01WeaponSoundMap.Add(ECharacterMontageName::Unholster_Smooth, UnholsterSmoothSound);
}
