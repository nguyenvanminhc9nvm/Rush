...
static TMap<EMuzzleName, FMuzzleSettingsEntry> GSniper03MuzzleSettingsMap;
...
static void InitSniper03MuzzleSettingsMap()
{
    ...
    GSniper03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Hidden, HiddenEntry);
    ...
    GSniper03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer01, Silencer01Entry);
    ...
    GSniper03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer02, Silencer02Entry);
    ...
    GSniper03MuzzleSettingsMap.Add(EMuzzleName::Muzzle_Silencer03, Silencer03Entry);
}

FMuzzleSettingsEntry USniper03MuzzleSettingsLibrary::GetSniper03MuzzleSettingsByName(EMuzzleName MuzzleName)
{
