...
namespace RushGameplayTag
{
	...
	RUSH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Holster);
	RUSH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Jump);
	RUSH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_FreeLook);
	RUSH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Lean);
	...
	RUSH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Holster);
	RUSH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Jump);
	RUSH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_FreeLook);
	RUSH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Lean);
